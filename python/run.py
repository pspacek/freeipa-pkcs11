...
if __name__ == '__main__':
    ...
    rep1_pub = p11.find_keys(ipapkcs11.KEY_CLASS_PUBLIC_KEY, label=u"replica1", cka_wrap=True)
    ...
    rep2_priv = p11.find_keys(ipapkcs11.KEY_CLASS_PRIVATE_KEY, label=u"replica2", cka_unwrap=True)[0]
    rep2_pub = p11.find_keys(ipapkcs11.KEY_CLASS_PUBLIC_KEY, label=u"replica2", cka_wrap=True)[0]
    ...
    p11.set_attribute(rep1_pub, ipapkcs11.CKA_LABEL, u"newlabelž")
    log.debug("get label: %s", p11.get_attribute(rep1_pub, ipapkcs11.CKA_LABEL))
    try:
